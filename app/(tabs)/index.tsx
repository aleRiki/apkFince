...
import { mockAccounts, mockBudgets, mockCreditCards, mockTransactions } from '@/constants/mockData';
...
export default function HomeScreen() {
  ...
  const monthlyProgress = monthlyIncome > 0 ? (monthlyExpenses / monthlyIncome) * 100 : 0;
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <View>
            <Text style={styles.greeting}>Hola, {user?.name || 'Familia'}</Text>
        ...
        >
          ...
          <View style={styles.balanceBadge}>
            ...
            <Text style={styles.balanceBadgeText}>+2,450.10 esta semana</Text>
          </View>
        </LinearGradient>
          ...
          <View style={styles.summaryCard}>
            ...
            <View style={styles.progressContainer}>
              <View style={styles.progressBar}>
                <View style={[styles.progressFill, { width: `${Math.min(monthlyProgress, 100)}%` }]} />
              </View>
              <Text style={styles.progressText}>{monthlyProgress.toFixed(0)}% del ingreso gastado</Text>
            </View>
          </View>
        </View>
